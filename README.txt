...
Simple bashscript that creates a backup of mysqldump and files. I am using it for a backup of wordpress.
After compressing and copying the mysqldump and files, the script sends a status email about success/failure.
